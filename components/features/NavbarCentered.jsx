...
function NavbarCentered({ contactScrollToRef }) {
                        ...
                        <div className="w-full flex justify-center pl-2 max-h-[100px] h-[100px]">
                            ...
                            <Popover.Group as="nav" className="hidden space-x-10 md:flex lg:pt-3">
                                <div className="absolute right-0 mt-4 mb-5 flex flex-row mr-8">
                                    ...
                                    {/*</div>*/ }
                                    <a
                                        className="flex items-center mt-1 justify-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700"
