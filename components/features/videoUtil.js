...
export const videos = [
    {
        src: '/vids/ArcCard.mp4',
        text: 'ARC was founded in 2020 with a rebellious spirit, born from the belief that the world would be a more beautiful place if we embraced uniqueness and celebrated individuality. Our goal was ambitious, but simple: to create a one-of-a-kind world of discovery that was more than just a beauty destination.'
    },
    {
    ...
    },
    {
        ...
        text: 'Today we operate with the philosophy of enhancing the existing capability of every stakeholder, including partnerships with global brand owners, employees and suppliers, so that together we can become the best versions of ourselves. We work alongside our Brand Principals and Retail Partners to deliver above market growth.\n' +
            'Appropriate distribution and retailer partnerships are crucial to our business. We spend an enormous amount of time to maximise the consumer experience by optimising our distribution strategies and capabilities.\n' +
            'Through selective distribution we take care to ensure that each product is the best available and is tailored to each brand’s needs, so that we may bring luxury to our customer base.\n'
    },
    {
    ...
    },
    {
        ...
        text: 'Our brand strives to serve beyond the realm of cosmetic beauty by delivering best-in-class innovation for the treatment of skin concerns ranging from acne to advanced signed of ageing and skin sensitivity. Through education, innovation, and professional recommendation, Dermalogica delivers the best in professional skin care to all South African skin types, without the promise of miracle cures and overblown hype.\n' +
            'Dermalogica is proud to serve the professional skin care industry and supports the development and upliftment of professional skin therapists across Africa and across the Globe.\n'
    },
    {
        src: '/vids/ArcCard.mp4',
        text: 'ARC was founded in 2020 with a rebellious spirit, born from the belief that the world would be a more beautiful place if we embraced uniqueness and celebrated individuality. Our goal was ambitious, but simple: to create a one-of-a-kind world of discovery that was more than just a beauty destination.'
...
export const videosComponentsSpotlight = [
