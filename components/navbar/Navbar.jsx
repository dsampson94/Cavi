            ...
            <Popover className="relative bg-white">
                <nav className="mx-auto flex max-w-7xl items-center justify-between pb-2 px-6 md:justify-start md:space-x-10 lg:px-8">
                    ...
                    <Popover.Group as="nav" className="hidden space-x-10 md:flex">
                        ...
                        { navigation.map((item) => (
                            <a key={ item.name } href={ item.href } className="text-base font-medium text-gray-500 hover:text-gray-900 pr-4 pt-2">
                                { item.name }
                            </a>
                        )) }
                    ...
                    <div className="flex">
                        { socials.map((item) => (
                            <a key={ item.name } href={ item.href } className="text-gray-400 hover:text-gray-500 mt-2 mr-2">
