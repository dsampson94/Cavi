...
import {
  ...
  AGGREGATE_TOP_SOIL, CHART_USAGE_MENU, CHART_USAGE_SASRI_MENU,
  CIRCLE_DROPDOWN, DAILY_ETO, DEFICIT_ETO,
  EXTENDED,
  SETTINGS_GEAR, SINGLE_DROPDOWN, VOLT_READINGS
      ...
      <div className={ getClassNames('chart__header', {
        ...
        { !chartName.includes('deficit') &&
          <div className="chart__header__center-text">
            ...
            { chartName === DEFICIT_ETO && <p>{ 'ETc (Usage / ETo)' }</p> }
            { chartName === VOLT_READINGS && <p>{ 'Volt Readings' }</p> }
