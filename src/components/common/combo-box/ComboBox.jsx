...
export default function ComboBox({ list }) {
  ...
  const filteredItem = query === '' ? list : list.filter((item) => {
  ...
  return (
    <Combobox as="div" value={ selectedItem } onChange={ setSelectedItem }>
      <div className="relative mt-1">
        <Combobox.Input
          className="relative w-full cursor-default rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 sm:text-sm"
